...
public class PostServiceImpl implements  PostService{
    ...
    public PostServiceImpl(PostRepository postRepository, UserRepository userRepository, PostedRepository postedRepository) {
    ...
    public void addPost(Post post) {
        User user = userRepository.getByEmail(post.getUserid());
        postRepository.addPost(post.getDescription(), post.getLikes(), post.getLatitude(), post.getLongitude(),
                post.getLocation(), post.getUserid());
        postedRepository.addPosted(user.getEmail());
    }
